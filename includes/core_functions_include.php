...
function format_date($format, $time) {
    // مصفوفة أسماء الأشهر باللغة العربية
    $arabic_months = [
    ...
    // استبدال أسماء الأشهر الإنجليزية بالأشهر العربية، مع التأكد من الاستبدال الكامل فقط
    $formatted_date = str_replace(array_keys($arabic_months_full), array_values($arabic_months_full), $formatted_date);
    $formatted_date = str_replace(array_keys($arabic_months), array_values($arabic_months), $formatted_date);
