...
// add_to_head("<link rel='stylesheet' href='".THEME."assets/css/main.css?v=".filemtime(THEME.'asset/css/main.css')."'>");
...
function render_page()
{
	...
	echo '<div id="main-content" style="padding: 0px" class="'.$padding_left.$padding_right.'col-xs-12 col-sm-'.$content['sm'].' col-md-'.$content['md'].' col-lg-'.$content['lg'].'">';
