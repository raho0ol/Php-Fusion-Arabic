...
add_to_head("<link rel='stylesheet' href='".THEME."asset/css/main.css?v=".filemtime(THEME.'asset/css/main.css')."'>");
        ...
        <div id="banner" class="box container">
            <div class="row">
                <div class="col-7 col-12-medium">
                    ...
                    <p>Its a free responsive site template by HTML5 UP</p>
                </div>
                <div class="col-5 col-12-medium">
                    <ul>
                        <li><a href="#" class="button large icon solid fa-arrow-circle-right">Ok lets go</a></li>
