    ...
    private function shoutsAdminListing() {
        ...
        if ($rows > 0) {
            ...
            while ($data = dbarray($result)) {
                ...
                echo display_avatar($data, '30px', '', !empty($item['user_id']), 'img-rounded pull-left m-l-10');
                ...
                echo '</div>';
                echo '<div class="col-sm-3">';
                echo '<div class="btn-group btn-group-sm pull-right m-r-20">';
            ...
            echo "</div>\n";
            echo form_button('sb_admins', self::$locale['SB_selected_shout'], self::$locale['SB_selected_shout'], ['class' => 'btn-danger', 'icon' => 'fa fa-trash m-l-5']);
            echo closeform();
